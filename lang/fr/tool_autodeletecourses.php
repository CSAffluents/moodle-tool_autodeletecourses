...
/**
 * Strings for component 'tool_autodeletecourses', language 'fr'.
 *
...
$string['nocoursetodelete'] = 'Il n\'y a actuellement aucun cours à supprimer. Vous pouvez modifier au besoin les règles de filtrage dans les réglages du plugin.';
...
$string['reportdeletestatus'] = 'Status de la suppression automatique de chaque cours :';
$string['reportintro'] = 'Voici le rapport sur le status de la suppression automatique des cours.';
$string['reportsubject'] = '{$a} : rapport de suppression automatique des cours';
$string['reportsuccesscount'] = 'Il y a {$a} cours qui ont été supprimés avec succès.';
$string['reportremainingcount'] = 'Il reste {$a} cours à supprimer basé sur les réglages de suppression actuels.';
$string['reportrenocourseremaining'] = 'Il ne reste aucun cours à supprimer.';
$string['reportstatusincomplete'] = 'INCOMPLET: Le cours intitulé {$a->fullname} n\'a pas été complètement supprimé a cause d\'une erreur.';
$string['reportstatusmissing'] = 'MANQUANT: Le cours intitulé {$a->fullname} était déjà supprimé.';
$string['reportstatusok'] = 'SUPPRIMÉ: Le cours intitulé {$a->fullname} a été supprimé avec succès.';
